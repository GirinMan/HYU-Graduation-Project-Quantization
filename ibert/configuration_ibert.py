...
class IBertConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        quant_mode=False,
        quant_mode_embedding=False,
        quant_mode_layer=[False]*12,
        quant_mode_attention=False,
        quant_mode_intermediate=False,
        force_dequant="none",
        **kwargs,
    ):
        ...
        self.quant_mode_embedding = quant_mode_embedding
        self.quant_mode_layer = quant_mode_layer
        self.quant_mode_attention=quant_mode_attention
        self.quant_mode_intermediate=quant_mode_intermediate
